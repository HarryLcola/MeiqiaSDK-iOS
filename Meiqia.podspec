...
Pod::Spec.new do |s|
  ...
  s.subspec 'MQChatViewController' do |ss|
    ...
    ss.source_files = 'Meiqia-SDK-files/MeiqiaSDKViewInterface/*.{h,m,xib}', 'Meiqia-SDK-files/MQChatViewController/**/*.{h,m,mm,cpp,xib}', 'Meiqia-SDK-files/MQMessageForm/**/*.{h,m,xib}'
