...
Pod::Spec.new do |s|
  ...
  s.subspec 'MQChatViewController' do |ss|
    ...
    ss.source_files = 'Meiqia-SDK-files/MeiqiaSDKViewInterface/*.{h,m}', 'Meiqia-SDK-files/MQChatViewController/**/*.{h,m,mm,cpp,xib}', 'Meiqia-SDK-files/MQMessageForm/**/*.{h,m,xib}'
